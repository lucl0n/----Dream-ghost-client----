...
client_config = {
    ...
    "velocity_delay": "5",
    "aimassist_speed": "20",
    "aimassist_walls": True,
    "clicker_keybind": -1,
    "reach_sprinting": True,
    "tracers_keybind": -1,
    ...
    "velocity_clicking": True,
    "velocity_vertical": "100",
    "aimassist_clickaim": True,
    ...
    "aimassist_multipoint": True,
    "bridge_assist_blocks": True,
    ...
    "bridge_assist_pitch_check": True,
}
    ...
    return [
        {
            ...
            "beta": True,
            "features": [
                {"text": "ArrayList", "type": "add"},
                {"text": "NameTags", "type": "add"},
                {"text": "New ESP design", "type": "modify"},
                {"text": "Minor bugs", "type": "modify"},
            ],
            "created_at": "2022-08-05T20:52:22.000000Z",
            "updated_at": "2022-08-05T20:52:22.000000Z",
        },
        {
            "id": 27,
            "version": "4.7.1",
            "beta": False,
            "features": [{"text": "Fixed issues regarding Badlion Client", "type": "modify"}],
            "created_at": "2022-08-03T20:30:51.000000Z",
            "updated_at": "2022-08-03T20:30:51.000000Z",
        },
        {
            "id": 26,
            "version": "4.6d",
        ...
        },
        {
            ...
            "features": [
                ...
                {
                    "text": "Recoded Reach (added disable in liquids, sprinting only, hit through walls)",
                    "type": "add",
                },
                {
        ...
        },
        {
            ...
            "features": [
                ...
                {
                    "text": "Complete ground up recode of the website with a stylish and secure design",
                    "type": "modify",
                },
        ...
        "modules": [
            {
                ...
                "settings": [
                    ...
                    },
                    {
                        ...
                        "desc": "Allows clicking on menu windows (ON MAINTENANCE DO NOT USE)",
                        "type": "toggle",
                        "default": False,
                    },
                    {
            ...
            {"id": "array_list", "name": "ArrayList", "icon": "list", "settings": []},
            {"id": "nametags", "name": "Nametags", "icon": "user-tag", "settings": []},
            {
                "id": "tracers",
                "name": "Tracers",
                "icon": "arrows-alt-h",
